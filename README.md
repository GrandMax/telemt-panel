...
# GOTO
- [MTPannel + MTProxy (Fake TLS) + Traefik](#mtpannel--mtproxy-fake-tls--traefik) — установка одним скриптом
- [Features](#features)
...
Установка MTProxy (Fake TLS) + Traefik одним скриптом описана в начале README: [MTPannel + MTProxy (Fake TLS) + Traefik](#mtpannel--mtproxy-fake-tls--traefik). Подробные опции, подкоманды и переменные окружения: [docs/install.md](docs/install.md).
